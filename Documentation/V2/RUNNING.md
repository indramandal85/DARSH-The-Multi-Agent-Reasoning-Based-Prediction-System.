# RUNNING.md — NeuroSwarm v2 Complete Run Instructions
...
### Home Screen
The home screen shows the NeuroSwarm title with animated background. Click **"Start Prediction"** to enter the app.
...
### Phase 4 Features (appear after graph is built)
...
# {"message":"NeuroSwarm API is running","status":"ok"}
```
...
git add .
git commit -m "NeuroSwarm v2.0 — all 4 phases complete"
```
